...
#define USBD_PRODUCT_HS_STRING          "STM32 VIDEO Streaming in HS Mode"
...
*/
uint8_t *  USBD_USR_DeviceDescriptor( USBD_SpeedTypeDef speed , uint16_t *length)
{
...
* @retval pointer to descriptor buffer
*/
uint8_t *  USBD_USR_LangIDStrDescriptor( USBD_SpeedTypeDef speed , uint16_t *length)
{
...
* @retval pointer to descriptor buffer
*/
uint8_t *  USBD_USR_ProductStrDescriptor( USBD_SpeedTypeDef speed , uint16_t *length)
{
...
* @retval pointer to descriptor buffer
*/
uint8_t *  USBD_USR_ManufacturerStrDescriptor( USBD_SpeedTypeDef speed , uint16_t *length)
{
...
* @retval pointer to descriptor buffer
*/
uint8_t *  USBD_USR_SerialStrDescriptor( USBD_SpeedTypeDef speed , uint16_t *length)
{
...
* @retval pointer to descriptor buffer
*/
uint8_t *  USBD_USR_ConfigStrDescriptor( USBD_SpeedTypeDef speed , uint16_t *length)
{
  if(speed  == USB_OTG_SPEED_HIGH)
  {  
...
* @retval pointer to descriptor buffer
*/
uint8_t *  USBD_USR_InterfaceStrDescriptor( USBD_SpeedTypeDef speed , uint16_t *length)
{
  if(speed == 0)
  {
