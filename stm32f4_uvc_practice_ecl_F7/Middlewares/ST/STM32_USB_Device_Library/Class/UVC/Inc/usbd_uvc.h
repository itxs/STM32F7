...
#define UVC_NAME		"STM32F7 UVC PRACTICE"
#define UVC_FPS			30
#define UVC_BPP			24
#define UVC_IMG_WIDTH	160
#define UVC_IMG_HEIGHT	120
#define UVC_IMG_FORMAT	MEDIASUBTYPE_GUID_RGB24
